...
1. パスカル・ボーネット，ヨッヘン・ウィルツ（著），NTTデータ・コンサルティング・イニシアティブ（訳）．[エージェント型AI－ビジネス、働き方を一変させる協働知革命](https://www.fortience.com/insight/books/251217/)（邦訳書）．ダイヤモンド社（2025）

    + NTTデータ・コンサルティング・イニシアティブのプロジェクトメンバーとして，一部翻訳に関する協力及び，日本語版解説・あとがき（一部）の執筆を担当しました（巻末等に氏名が掲載されています）．また，出版記念セミナー（[エージェント型AI ビジネス、働き方を一変させる協働知革命](https://www.fortience.com/insight/seminar-event/2026012800/)）の第2部でも登壇発表をさせていただきました．
    + 書籍は，エージェント型AIの仕組みと活用方法が概観できるビジネスパーソン向けのものです．

2. マイケル・リューリック，オマール・ハタムレー（著），NTTデータ・コンサルティング・イニシアティブ（訳）．[AI AND INNOVATIONーAIで未来を先取りし、ビジネスを変革する方法](https://www.fortience.com/insight/books/251210/)（邦邦書）．東洋経済新報社（2025）

    + NTTデータ・コンサルティング・イニシアティブのプロジェクトメンバーとして，一部翻訳に関する協力を担当しました（巻末に氏名が掲載されています）．
